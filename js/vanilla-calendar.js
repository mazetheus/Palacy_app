    ...
    function VanillaCalendar(options) {
        ...
        const createCalendar = function () {
            ...
            <div class="vanilla-calendar-header">
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="previous"><i class="fas fa-chevron-circle-left"></i></button>
                <div class="vanilla-calendar-header__label" data-calendar-label="month"></div>
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="next"><i class="fas fa-chevron-circle-right"></i></button>
            </div>
